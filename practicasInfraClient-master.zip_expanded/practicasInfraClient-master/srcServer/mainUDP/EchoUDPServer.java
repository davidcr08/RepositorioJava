...
public class EchoUDPServer {
	...
	/*
	 *METODO QUE INICIA CON LA EJECUCION DEL SERVIDOR
	 */
	public void init() throws Exception {
		
		//se agrega el puerto al socket
	...
	private void send(String messageToSend) throws Exception {
		...
		DatagramPacket packetToSend = new DatagramPacket(bufferToSend, bufferToSend.length, clientIPAddress, clientPort);
